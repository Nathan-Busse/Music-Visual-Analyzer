from Music_Visual_Analyzer import *
import random
import colorsys
...
foldername = "Music/Armin van Buuren - This Is A Test (Extended Mix).mp3"
...
screen_w = int(infoObject.current_w/1)
screen_h = int(infoObject.current_w/1)
...
pygame.mixer.music.load(foldername)
